...
Public Class ReportAHTRepo
    Implements IReportAHTRepo
    ...
    Public Async Function Calculate(form As FormModel) As Task(Of String) Implements IReportAHTRepo.Calculate
